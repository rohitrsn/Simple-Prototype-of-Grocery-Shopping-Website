...
var appleItem = new foodItem("apple", "fruit", 100, 1.00, false);

var bananaItem = new foodItem("banana", "fruit", 40,.59, false) ;

var orangeItem = new foodItem("orange","fruit", 50, 1.50,true);

var blueberryItem = new foodItem("blueberry","fruit", 50, 2.50,true);

var grapeItem = new foodItem("grapes","fruit", 30, 4.50,true);

var pearItem = new foodItem("pear","fruit", 35, 1.50,false);

//Objects for Veggie class

var pepperItem = new foodItem("pepper", "veggie", 30, .79, false);

var carrotItem = new foodItem("carrot", "veggie", 50, 2.99, false);

var yellowSquashItem = new foodItem("yellowsquash", "veggie", 45, 2.19, true);

var eggplantItem = new foodItem("eggplant", "veggie", 35, 2.49, false);

var lettuceItem = new foodItem("lettuce", "veggie", 45, 1.79, false);

var potatoItem = new foodItem("potato", "veggie", 60, 3.49, false);

//Objects for Dairy class
var milkItem = new foodItem("milk", "dairy", 150, 3.49, false);

var garlicItem = new foodItem("garlic", "dairy", 120, 1.49, false);

var butterItem = new foodItem("butter", "dairy", 125, 3.49, true);

var breadItem = new foodItem("bread", "dairy", 130,3.59,false);

var cheeseItem = new foodItem("cheese", "dairy", 155,4.59,false);

var eggsItem = new foodItem("eggs", "dairy", 140,4.59,false);
